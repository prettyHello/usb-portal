...
Route::get('/history', 'ActionPageController@get');
...
//show the document
Route::get('/document/show/{document}', 'DocumentController@showDocument');

// print
Route::get('/print/{document}', 'PrintPageController@printDocument');
